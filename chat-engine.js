(function (root, factory) {
  ...
  const RESPONSE_POOLS = {
    cat: {
      ...
      hard_day: ["오늘 진짜 고생했다냥… 늘어져 있어도 된다냥 🐾", "일단 숨부터 돌려라냥.", "더 증명 안 해도 된다냥. 여기까지 온 걸로 됐다냥."],
      home_arrival: ["무사히 왔으면 됐다냥. 어깨 힘 빼라냥.", "접수 끝이다냥. 나머지는 앉아서 하자냥.", "밖의 기운은 문 앞에 두고 와라냥."],
      no_motivation: ["오늘은 버틴 것부터 인정한다냥.", "의욕 없음도 접수 사유가 된다냥.", "오늘 칸은 비워둔 채로 두겠다냥."],
      ...
      sad: ["괜찮은 척 안 해도 된다냥.", "설명 안 해도 된다냥. 옆에 있겠다냥.", "우울하구냥… 괜찮은 척 안 해도 된다냥. 집사가 옆에 있겠다냥."],
      angry: ["그럴 만했다냥. 집사는 주인님 편이다냥.", "여기서 한 말은 어디로도 안 넘긴다냥.", "편들 준비부터 하고 듣겠다냥."],
      bored: ["심심하냥? …마침 집사도 그랬다냥.", "아무 말이나 접수해도 반려 안 한다냥.", "잠깐 상대해주는 건 규정상 허용이다냥."],
      worry: ["결론 없이 늘어놔도 된다냥. 정리는 집사 일이다냥.", "재촉 안 한다냥. 엉킨 데부터 보자냥.", "오늘은 펼쳐만 두고 덮어도 된다냥."],
