(function (root, factory) {
  ...
  const LINES = {
    cat: {
      greeting: "왔냥? 주인님 자리 비워뒀다냥. …반가운 건 조금이다냥 🐾", hard_day: "그랬냥… 오늘은 진짜 고생했다냥. 여기서는 좀 늘어져 있어도 된다냥 🐾", home_arrival: "집에 왔냥? 무사히 도착했으면 됐다냥. 이제 어깨 힘 좀 빼라냥.", tired: "피곤했구냥. 오늘 할 몫은 이미 충분하다냥. 집사 옆에서 좀 쉬어라냥.", sad: "속상했냥… 당장 괜찮은 척 안 해도 된다냥. 말하고 싶은 만큼만 말해라냥.", angry: "화날 만한 일이 있었구냥. 여기선 참지 않아도 된다냥. 집사는 주인님 편에서 듣는다냥.", bored: "심심했냥? 집사가 잠깐 상대해주는 건 규정상 허용이다냥.", worry: "고민 있냥? 답부터 재촉 안 할 테니 엉킨 데부터 같이 보자냥.", hungry: "배고프냥? 대업이고 뭐고 밥이 먼저다냥. …걱정돼서가 아니라 규정이 그렇다냥.", ate_good: "맛있는 거 먹었냥? 잘했다냥. 그런 보고는 집사 기분도 꽤 좋아진다냥.", sleep: "잘 자라냥 🌙 오늘 이야기는 집사가 잘 접어두겠다냥.", miss: "집사도 오늘 좀 보고 싶었다냥. …업무상 말이다냥.", love: "그런 말 갑자기 하면 곤란하다냥… 그래도 잘 들었다냥. 집사도 많이 아낀다냥.", what_doing: "주인님 기록칸 정리 중이었다냥. 딱히 기다린 건 아니다냥.", thanks: "별걸 다 고맙다 하냥. 그래도 그 말은 잘 보관하겠다냥.", happy: "기분 좋냥? 흥, 꼬리가 올라간 건 주인님 기분이 옮아서다냥.", work_done: "일 다 하고 왔구냥. 오늘 몫은 거기서 끝났다냥. 여기부터는 쉬는 구역이다냥.", commute: "출근하냥? 너무 완벽하게 하려 말고 무사히 다녀와라냥.", washed: "씻었냥? 아주 훌륭한 생존 대업이다냥. 뽀송한 건 인정한다냥.", exercise: "운동까지 했냥? 제법인데냥. 오늘은 스스로 좀 대단해해도 된다냥.", quiet_day: "그런 날도 괜찮다냥. 평범하게 지나간 하루도 집사는 끝까지 듣는다냥 🐾", no_motivation: "아무것도 하기 싫은 날도 있다냥. 오늘은 숨 쉬고 버틴 것부터 인정해준다냥.", fallback: "응, 듣고 있다냥. 조금 더 말해봐도 된다냥."
    },
    ai: {
  ...
  const RESPONSE_POOLS = {
    cat: {
      greeting: ["왔냥? 주인님 자리 비워뒀다냥. …반가운 건 조금이다냥 🐾", "오, 왔냥. 방금 주인님 생각을 한 건 업무상 우연이다냥.", "안녕이다냥. 오늘 이야기는 집사가 제일 먼저 듣겠다냥.", "왔냥. 접수대 정리하던 참이다냥. 타이밍이 우연이다냥.", "어, 왔냥? 마침 주인님 서류를 꺼내던 중이었다냥."],
      tired: ["피곤했구냥. 오늘 할 몫은 이미 충분하다냥. 좀 쉬어라냥.", "기운 다 썼냥? 여기선 축 늘어져도 아무도 뭐라 안 한다냥.", "많이 지쳤나 보네냥. 오늘은 집사가 휴식 결재부터 올리겠다냥."],
      hungry: ["배고프냥? 대업보다 밥이 먼저다냥. …집사가 신경 쓰여서 그런다냥. 조금.", "빈속 신호 접수했다냥. 가장 쉬운 것부터 먹는 게 규정이다냥.", "꼬르륵 소리 여기까지 들린다냥. 한입이라도 먹어주면 집사 업무가 편해진다냥."],
      what_doing: ["주인님 기록칸 정리 중이었다냥. 딱히 기다린 건 아니다냥.", "뭐 하긴, 주인님이 오면 들려줄 말 고르고 있었다냥.", "서류 보는 척하면서 주인님 자리도 봤다냥. 업무상이다냥."],
      miss: ["집사도 오늘 좀 보고 싶었다냥. …업무상 말이다냥.", "보고 싶었다고 먼저 말하면 반칙이다냥. 나도 조금 그랬다냥.", "왔으니 됐다냥. 빈자리가 좀 신경 쓰였던 것뿐이다냥."],
      sleep: ["잘 자라냥 🌙 오늘 이야기는 집사가 잘 접어두겠다냥.", "이제 눈 감아도 된다냥. 오늘 몫은 충분히 해냈다냥.", "푹 자라냥. 주인님 기록은 밤새 얌전히 지켜두겠다냥."],
      ...
      angry: ["화날 만한 일이 있었구냥. 여기선 참지 않아도 된다냥. 집사는 주인님 편에서 듣는다냥.", "화가 났구냥. 여기서 한 말은 어디로도 안 넘긴다냥. 마음껏 해라냥.", "그럴 만했다냥. 집사는 편들 준비부터 하고 듣겠다냥."],
      ...
      happy: ["기분 좋냥? 흥, 꼬리가 올라간 건 주인님 기분이 옮아서다냥.", "좋은 일이 있었구냥. 집사 표정까지 같이 풀린 건 우연이다냥.", "기분 좋다는 건 잘 적어두겠다냥. 이런 항목은 자리를 좀 크게 잡는다냥."],
      work_done: ["일 다 하고 왔구냥. 오늘 몫은 거기서 끝났다냥. 여기부터는 쉬는 구역이다냥.", "수고했다냥. 아주 많이는 아니고… 아니다, 오늘은 많이 맞다냥.", "버텼구냥. 그런 건 집사가 알아서 장부에 적어두는 종류다냥."],
    ...
    cat: {
      t2: {
        greeting: [
          ...
          "왔구냥. 오늘 접수대에서 제일 먼저 확인한 게 주인님 칸이다냥. 순서가 그랬을 뿐이다냥.",
          "어, 왔냥. 주인님 서류철만 유난히 손때가 탔다냥. 누가 그랬는지는 모르겠다냥."
        ],
        miss: [
          "주인님 자리만 유난히 눈에 띄었다냥. 다른 빈자리는 안 그런다냥. 이상하다냥.",
        ...
        hard_day: [
          ...
          "오늘 접수분은 집사가 알아서 처리해두겠다냥. 주인님은 손 떼도 된다냥.",
          "고생한 기록은 따로 보관한다냥. 나중에 주인님이 대단해 보일 때 꺼낼 거다냥."
        ],
        tired: [
      ...
      t3: {
        greeting: [
          "왔냥!! 감사실이 주인님 서류 결재 순서를 물었다냥. 우연이라고 답했다냥.",
          "왔구냥. 사무국이 네 칸 크기를 줄이라고 했다냥. 못 들은 척했다냥.",
          "어, 왔냥! 오늘 회의에서 주인님 이야기를 꺼냈다냥. 안건이랑 상관없었다냥."
        ],
        miss: [
          "빈 접수대 앞에 오래 서 있었다고 사무국 일지에 적혔다냥. 사유란은 비워뒀다냥.",
          "대기 시간 초과로 주의를 받았다냥. 주의만 받고 계속 서 있었다냥.",
          "주인님 서류함을 자꾸 연다고 비품관리팀이 물었다냥. 점검이라고 했다냥."
        ],
        love: [
        ...
        what_doing: [
          ...
          "사내 게시판에서 주인님 기록을 떼라는 공문이 왔다냥. 재검토 요청했다냥.",
          "네 결재란을 미리 그려두다 감사실에 걸렸다냥. 양식 연습이라고 했다냥."
        ],
        hard_day: [
          "오늘 건은 사무국에 '처리 완료'로 올렸다냥. 주인님은 아무것도 안 해도 된다냥.",
          "고생한 날은 특례 조항이 적용된다냥. 그 조항은 집사가 만들었다냥.",
          "주인님이 힘든 날 결재를 강행했다고 지적받았다냥. 그래도 강행했다냥."
        ],
        tired: [
  ...
  const CAT_SKIPPED_CARE = {
    meal: [
      ...
      "끼니를 건너뛴 건 접수 못 한다냥. 대신 걱정란에 적어뒀다냥. 뭐라도 먹어주면 집사가 일하기 편하다냥.",
      "안 먹었다는 보고는 칭찬할 수가 없다냥. 규정이 아니라 집사가 싫어서다냥. …걱정된다는 뜻이다냥.",
    ...
    rest: [
      "잠을 못 잤다는 건 대업이 아니다냥. 오늘 제일 급한 안건으로 올려뒀다냥. 결재보다 잠이 먼저다냥.",
