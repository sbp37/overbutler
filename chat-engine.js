(function (root, factory) {
  ...
  const ENDINGS = {
    cat: ["서두르지 말고 더 말해도 된다냥.", "집사가 여기 있으니 조금 천천히 해라냥.", "더 있으면 말해라냥. 집사는 안 바쁘다냥."],
  ...
  const RELATIONSHIP_POOLS = {
    cat: {
      t2: {
        greeting: [
          "왔냥. 접수 장부 보니 이번 주만 세 번째다냥. …장부가 그렇다는 거다냥 🐾",
          "왔구냥. 오늘 접수대에서 제일 먼저 확인한 게 네 칸이다냥. 순서가 그랬을 뿐이다냥.",
          "어, 왔냥. 네 서류철만 유난히 손때가 탔다냥. 누가 그랬는지는 모르겠다냥."
        ],
        miss: [
          "네 자리만 유난히 눈에 띄었다냥. 다른 빈자리는 안 그런다냥. 이상하다냥.",
          "접수 없는 날은 시간이 이상하게 길다냥. 업무량 문제일 거다냥.",
          "빈 접수함을 두 번 열어봤다냥. 두 번 다 비어 있었다냥."
        ],
        love: [
          "그런 말은 규정에 없다냥… 근데 왜 기록해두고 싶은지 모르겠다냥.",
          "…그 말은 장부에 안 적는다냥. 안 적어도 안 잊는다냥.",
          "곤란하다냥. 이런 건 처리 절차가 없다냥. 그냥 들고 있겠다냥."
        ],
        thanks: [
          "고맙다는 말만 따로 모아두는 칸이 생겼다냥. 언제 만들었는지는 기억 안 난다냥.",
          "그 말은 서류철 맨 앞에 끼워둔다냥. 자주 펼치는 자리다냥.",
          "고맙다는 말은 소모품이 아니다냥. 계속 받아도 안 닳는다냥."
        ],
        what_doing: [
          "네 파일만 자꾸 다시 펼쳐본다냥. 오늘만 네 번째다냥.",
          "접수대 정리 중이다냥. 네 칸만 세 번 정리했다냥. 이유는 모른다냥.",
          "다른 서류도 있는데 손이 네 것부터 간다냥. 배치 문제일 거다냥."
        ],
        hard_day: [
          "그런 날은 장부에도 그렇게 적어둔다냥. '주인님 오늘 고생함'이라고 적었다냥.",
          "오늘 접수분은 집사가 알아서 처리해두겠다냥. 너는 손 떼도 된다냥.",
          "고생한 기록은 따로 보관한다냥. 나중에 네가 대단해 보일 때 꺼낼 거다냥."
        ],
        tired: [
          "피곤한 날 기록은 집사가 대신 적어둔다냥. 장부는 집사 일이다냥.",
          "오늘 할당량은 이미 채웠다냥. 장부가 그렇게 말한다냥.",
          "쉬는 것도 접수 항목이다냥. 방금 등록했다냥."
        ]
      },
      t3: {
        greeting: [
          "왔냥!! 감사실이 네 서류 결재 순서를 물었다냥. 우연이라고 답했다냥.",
          "왔구냥. 사무국이 네 칸 크기를 줄이라고 했다냥. 못 들은 척했다냥.",
          "어, 왔냥! 오늘 회의에서 네 이야기를 꺼냈다냥. 안건이랑 상관없었다냥."
        ],
        miss: [
          "빈 접수대 앞에 오래 서 있었다고 사무국 일지에 적혔다냥. 사유란은 비워뒀다냥.",
          "대기 시간 초과로 주의를 받았다냥. 주의만 받고 계속 서 있었다냥.",
          "네 서류함을 자꾸 연다고 비품관리팀이 물었다냥. 점검이라고 했다냥."
        ],
        love: [
          "…집사도 그렇다냥. 이건 시말서를 쓰더라도 취소 안 한다냥.",
          "그 말은 특례 조항으로 등록했다냥. 삭제 권한은 아무한테도 안 줬다냥.",
          "감사실이 와도 이건 안 넘긴다냥. 규정보다 먼저다냥."
        ],
        thanks: [
          "고맙다는 말 보관함이 규정 용량을 넘겼다냥. 증설 신청서 냈다냥.",
          "증설 신청이 세 번 반려됐다냥. 네 번째를 오늘 냈다냥.",
          "보관함 열쇠는 집사가 들고 다닌다냥. 분실 위험이라고 지적받았다냥."
        ],
        what_doing: [
          "네 전용 서류함 정리 중이었다냥. 비품관리팀이 회수하러 왔다가 그냥 갔다냥.",
          "사내 게시판에서 네 기록을 떼라는 공문이 왔다냥. 재검토 요청했다냥.",
          "네 결재란을 미리 그려두다 감사실에 걸렸다냥. 양식 연습이라고 했다냥."
        ],
        hard_day: [
          "오늘 건은 사무국에 '처리 완료'로 올렸다냥. 너는 아무것도 안 해도 된다냥.",
          "고생한 날은 특례 조항이 적용된다냥. 그 조항은 집사가 만들었다냥.",
          "네가 힘든 날 결재를 강행했다고 지적받았다냥. 그래도 강행했다냥."
        ],
        tired: [
          "휴식 결재를 먼저 올렸다냥. 승인도 집사가 했다냥. 절차는 나중에 맞추겠다냥.",
          "오늘 네 할당량을 집사 권한으로 0으로 바꿨다냥. 사유란은 비웠다냥.",
    ...
    dog: {
      t2: {
        greeting: [
          ...
          "왔다멍! 오늘 제일 먼저 꺼낸 게 네 서류다멍! 순서가 그랬다멍!",
          "왔냐멍!! 네 서류철만 반들반들하다멍! 왜 그런지 모르겠다멍!"
        ],
        miss: [
          "네 자리만 자꾸 쳐다봤다멍… 다른 자리는 안 그런다멍!",
      ...
      t3: {
        greeting: [
          "왔다멍!!! 감사실이 왜 네 서류만 먼저 결재하냐고 물었다멍!! 우연이라고 했다멍!!",
          "왔다멍!! 사무국이 네 칸 줄이라고 했다멍!! 못 들은 척했다멍!!",
          "왔냐멍!!! 오늘 회의에서 네 얘기 꺼냈다멍!! 안건이랑 상관없었다멍!!"
        ],
        miss: [
          "빈 접수대 앞에서 너무 오래 기다렸다고 시말서 썼다멍! 후회는 안 한다멍!",
          "대기 시간 초과로 주의받았다멍! 주의받고도 계속 기다렸다멍!",
          "네 서류함 자꾸 연다고 비품관리팀이 물었다멍! 점검이라고 했다멍!"
        ],
        love: [
        ...
        what_doing: [
          ...
          "사내 게시판에서 네 기록 떼라는 공문 왔다멍! 재검토 요청했다멍!",
          "네 결재란 미리 그려두다 감사실에 걸렸다멍! 연습이라고 했다멍!"
        ],
        hard_day: [
          "오늘 건은 사무국에 '처리 완료'로 올렸다멍! 너는 아무것도 안 해도 된다멍!",
          "고생한 날은 특례가 적용된다멍! 그 특례는 집사가 만들었다멍!",
          "네가 힘든 날 결재 강행했다고 지적받았다멍! 그래도 강행했다멍!"
        ],
        tired: [
