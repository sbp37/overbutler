(function (root, factory) {
  ...
  const RESPONSE_POOLS = {
    cat: {
      ...
      angry: ["화날 만한 일이 있었구냥. 여기선 참지 않아도 된다냥. 집사는 네 편에서 듣는다냥.", "화가 났구냥. 여기서 한 말은 어디로도 안 넘긴다냥. 마음껏 해라냥.", "그럴 만했다냥. 집사는 편들 준비부터 하고 듣겠다냥."],
