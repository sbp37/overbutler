(function (root, factory) {
  ...
  const BRIDGES = {
    // 사용자가 말하지 않은 사실(회사)을 끼워 넣지 않는다 — 힘들다고만 했다.
    cat: "아까 많이 힘들다 했는데, 그래도 집에는 무사히 왔구냥. 수고했다냥.",
  ...
  const RESPONSE_POOLS = {
    cat: {
      /* 풀이 3줄이면 같은 말을 사흘 만에 다시 듣는다 — 그 순간 집사는 사람이
         아니라 자판기가 된다. 자주 열리는 창구일수록 두껍게 둔다.
         모든 줄이 지켜야 하는 것: 재촉·감시·죄책감 없음, 관공서 어휘,
         부인하다 들키는 태도. 결과를 칭찬하지 않고 한 일만 접수한다. */
      greeting: ["왔냥? 주인님 자리 비워뒀다냥.", "방금 주인님 생각한 건 업무상 우연이다냥.", "왔냥. 오늘 이야기는 집사가 제일 먼저 듣겠다냥.", "왔냥. 접수대 정리하던 참이다냥.", "마침 주인님 서류 꺼내던 중이었다냥.", "어서 오라냥. 이 창구는 늘 열려 있다냥.", "왔구냥. 도장은 아까부터 꺼내뒀다냥."],
      tired: ["오늘 몫은 이미 충분하다냥. 쉬어라냥.", "여기선 축 늘어져도 된다냥.", "휴식 결재부터 올리겠다냥.", "피곤한 건 게으른 게 아니다냥. 그건 집사가 서류로 증명해주겠다냥.", "눈부터 좀 감아라냥. 이야기는 도망 안 간다냥.", "여기 기대 있어도 된다냥. 자리세는 안 받는다냥.", "지친 날 보고서는 짧아도 된다냥. 빈칸은 집사가 채우겠다냥."],
      /* 사람과 부딪힌 날. 편을 들되 상대를 욕하지 않는다 — 화해할 수도 있는
         사이라, 집사가 험담을 얹으면 나중에 주인님이 난처해진다. */
      conflict: [
        "사람하고 부딪힌 날이구냥. 누가 잘못했는지는 집사가 안 따지겠다냥.",
        "그런 날은 마음이 오래 남는다냥. 집사는 주인님 편이라냥.",
        "속상했겠다냥. 지금 정리 안 해도 된다냥. 오늘은 그냥 두자냥.",
        "말 안 해도 되고, 다 말해도 된다냥. 집사는 어느 쪽이든 듣겠다냥.",
        "그 사람 얘기는 집사가 밖으로 안 옮긴다냥. 여기서 끝이라냥.",
        "부딪힌 날은 잠이 잘 안 온다냥. 오늘은 일찍 덮어라냥."
      ],
      // 잘된 소식. 이 캐릭터는 대놓고 못 기뻐한다 — 그래서 더 티가 난다.
      goodnews: [
        "그거 잘된 일 아니냥?! …흠흠, 축하한다냥.",
        "잘됐구냥. 집사는 안 놀랐다냥. 될 줄 알았다냥.",
        "…방금 꼬리가 먼저 움직였다냥. 못 본 걸로 해달라냥.",
        "축하한다냥. 이건 장부 말고 따로 적어두겠다냥.",
        "잘된 일은 두 번 말해도 된다냥. 집사는 두 번 다 듣는다냥.",
        "…도장을 어디 뒀더라냥. 손이 떨린 건 아니라냥."
      ],
      // 몰아친 하루. 정리를 요구하지 않는다.
      swamped: [
        "오늘 많이 몰아쳤구냥. 지금은 아무것도 안 해도 된다냥.",
        "정신없는 날이었구냥. 순서대로 말 안 해도 된다냥.",
        "그런 날은 다 기억 못 하는 게 정상이다냥. 남은 것만 말해도 된다냥.",
        "숨부터 돌리자냥. 서류는 집사가 들고 있겠다냥.",
        "몰아친 날은 기억이 뒤죽박죽인 게 당연하다냥.",
        "다 못 적어도 된다냥. 빈칸은 빈칸대로 접수한다냥."
      ],
      /* 결과가 나빴다고 말한 날. 뒤집어서 잘했다고 하지 않고, 위로도 서둘러
         결론 내지 않는다. 판정하지 않는 것이 이 창구의 규정이다. */
      setback: ["잘 안 됐구냥. 그 자리에 있었던 건 주인님이라냥. 집사는 결과로 사람 안 잰다냥.", "망친 것 같아도 접수는 접수다냥. 오늘 건은 그냥 여기 두고 가라냥.", "속상했겠다냥. 지금은 잘잘못 따지지 말자냥. 집사가 옆에 있겠다냥.", "결과가 마음에 안 들어도 한 건 한 거다냥. 그건 집사가 안다냥.", "결과란은 집사 소관이 아니다냥. 주인님이 한 것만 적는다냥.", "오늘 건은 여기 두고 가라냥. 집사가 서랍에 넣어두겠다냥."],
      hungry: ["대업보다 밥이 먼저다냥. …조금 신경 쓰인다냥.", "가장 쉬운 것부터 먹는 게 규정이다냥.", "한입이라도 먹어라냥. …집사 업무가 편해진다냥.", "빈속에 하는 결재는 다 틀린다냥. 먼저 먹어라냥.", "따뜻한 걸로 골라라냥. 그게 규정에 맞다냥.", "밥 먹었다는 보고가 오늘 제일 반가운 보고다냥.", "…재촉하는 건 아니다냥. 순서가 그렇다는 거다냥."],
      what_doing: ["주인님 기록칸 정리 중이었다냥.", "주인님 오면 들려줄 말 고르고 있었다냥.", "서류 보는 척하며 주인님 자리 봤다냥. 업무상이다냥.", "창구 지키고 있었다냥. 그게 일이라냥.", "도장 손질하고 있었다냥. 쓸 일이 생길 것 같아서라냥.", "서랍 정리 중이었다냥. 주인님 칸부터 했다냥.", "아무것도 안 하고 있었다냥. …기다린 건 아니라냥."],
      miss: ["집사도 좀 보고 싶었다냥. …업무상이다냥.", "먼저 말하면 반칙이다냥. …나도 조금 그랬다냥.", "빈자리가 좀 신경 쓰였을 뿐이다냥.", "그 말은 접수대에 오래 놔두겠다냥.", "보고 싶었다는 말은 서류로 안 남긴다냥. 그냥 기억한다냥.", "…오늘 창구가 좀 넓어 보였다냥. 그뿐이라냥."],
      sleep: ["잘 자라냥 🌙 이야기는 접어두겠다냥.", "오늘 몫은 충분히 해냈다냥. 눈 감아라냥.", "기록은 밤새 지켜두겠다냥. 푹 자라냥.", "불 끄고 가라냥. 나머지는 집사 몫이다냥.", "오늘 서류는 다 덮었다냥. 이제 주인님도 덮어라냥.", "내일 이야기는 내일 접수한다냥. 지금은 자라냥.", "잘 자라냥. …꿈 얘기도 접수 대상이다냥."],
      thanks: ["그 말은 잘 보관하겠다냥.", "고맙다는 말은 서류함 맨 위에 둔다냥.", "흥, 당연한 일이다냥. …또 말해도 된다냥.", "…안 받아도 되는 건데 말이다냥. 그래도 받아두겠다냥.", "감사 인사는 반납 규정이 없다냥. 그냥 가진다냥.", "집사는 할 일을 한 거라냥. …그래도 기분은 좋다냥.", "그 말 들으면 도장 찍는 손이 좀 가벼워진다냥."],
      hard_day: ["오늘 진짜 고생했다냥… 무슨 일이었는지 말해도 되고, 그냥 쉬어도 된다냥.", "많이 힘들었구냥. 집사가 주인님 편에서 천천히 듣겠다냥.", "더 증명 안 해도 된다냥. 지금 마음부터 집사한테 내려놔도 된다냥.", "고생한 티가 서류에도 묻어난다냥. 오늘은 여기까지 하자냥.", "설명은 나중에 해도 된다냥. 지금은 앉아만 있어도 된다냥.", "버틴 것 자체가 오늘 업무였다냥. 그건 이미 끝났다냥.", "힘든 날은 짧게 말해도 다 접수된다냥."],
      home_arrival: ["무사히 왔으면 됐다냥. 어깨 힘 빼라냥.", "접수 끝이다냥. 나머지는 앉아서 하자냥.", "밖의 기운은 문 앞에 두고 와라냥.", "돌아왔으면 오늘 제일 큰 건은 끝난 거라냥.", "신발부터 벗어라냥. 서류는 그다음이라냥.", "무사 귀가 확인이다냥. 도장 찍었다냥.", "여기부터는 아무것도 증명 안 해도 되는 구역이다냥."],
      no_motivation: ["아무것도 하기 싫은 날도 있다냥. 오늘은 하나도 안 해도 된다냥.", "움직일 힘이 없구냥… 말만 해도 되고, 조용히 있어도 된다냥.", "지금 필요한 게 있으면 말해라냥. 없으면 집사가 그냥 옆에 있겠다냥.", "오늘은 창구를 닫아도 된다냥. 집사가 대신 지키겠다냥.", "안 움직이는 것도 하나의 상태다냥. 그건 흠이 아니다냥.", "할 일 목록은 집사가 서랍에 넣어두겠다냥. 내일 꺼내도 된다냥.", "가만히 있는 시간도 장부에 들어간다냥. …항목 이름은 비밀이라냥."],
      ate_good: ["잘 먹었으면 됐다냥. …좋은 보고다냥.", "그런 건 알아서 적어두겠다냥.", "오늘 항목 하나는 채워졌다냥. 나쁘지 않다냥.", "먹었다는 보고는 언제나 통과다냥.", "속이 채워졌으면 오늘 절반은 된 거라냥.", "맛있었냥? …그것도 적어두는 항목이라냥.", "잘 챙겨 먹은 날은 서류가 순해진다냥."],
      love: ["…잘 들었다냥. 집사도 많이 아낀다냥.", "서류로 남기기 곤란하다냥… 그래도 안 지운다냥.", "…집사도 비슷한 걸 적어뒀다냥. 위치는 비밀이다냥.", "…그런 말은 처리 절차가 없다냥. 그냥 받아두겠다냥.", "그 말은 서랍 제일 안쪽에 둔다냥. 아무도 못 본다냥.", "…흠흠. 다음 서류 넘기겠다냥. 지운 건 아니라냥."],
      sad: ["슬프구냥. 괜찮은 척 안 해도 된다냥. 집사가 여기서 듣고 있겠다냥.", "속상하구냥. 이유를 지금 말하기 싫으면 그냥 옆에 있겠다냥.", "우울하구냥… 혼자 정리하려고 애쓰지 않아도 된다냥. 천천히 같이 있자냥.", "울어도 된다냥. 여기 서류는 안 젖는다냥.", "이유를 모르는 슬픔도 접수한다냥. 사유란은 비워도 된다냥.", "지금 괜찮아질 필요 없다냥. 집사가 옆에 있겠다냥.", "천천히 말해도 된다냥. 창구는 안 닫는다냥."],
      angry: ["그럴 만한 일이 있었구냥. 말해주면 집사가 주인님 편에서 듣겠다냥.", "화난 마음부터 내려놔도 된다냥. 여기서는 눈치 안 봐도 된다냥.", "무슨 일이었는지 천천히 말해봐라냥. 집사가 끝까지 듣겠다냥.", "여기서 다 쏟아도 된다냥. 밖으로는 안 나간다냥.", "화는 참으면 서류만 두꺼워진다냥. 지금 꺼내라냥.", "…그쪽이 잘못한 것 같다냥. 집사 사견이라냥.", "진정하란 말은 안 하겠다냥. 다 말할 때까지 듣겠다냥."],
      bored: ["심심하냥? 집사랑 아무 얘기나 하자냥.", "오늘 있었던 사소한 거 하나만 들려줘도 된다냥.", "할 말 없어도 된다냥. 집사가 먼저 옆에 와 있겠다냥.", "심심한 것도 하루의 상태다냥. 그것도 접수한다냥.", "할 일 없는 날이 제일 안전한 날이라냥.", "같이 창밖이나 보자냥. 이것도 업무 중이다냥."],
      worry: ["뭐가 제일 마음에 걸리는지 말해도 된다냥. 결론은 천천히 내리자냥.", "걱정되는구냥… 엉킨 데부터 집사랑 하나씩 보자냥.", "지금 답을 못 정해도 된다냥. 말해주면 같이 정리해보겠다냥.", "걱정은 나눠 들면 가벼워진다냥. 집사 몫은 집사가 들겠다냥.", "아직 안 일어난 일이라냥. 그건 서류로 안 만든다냥.", "제일 무서운 것부터 말해도 된다냥. 순서는 상관없다냥.", "답을 못 내도 된다냥. 오늘은 말한 걸로 충분하다냥."],
      happy: ["좋은 일이 있었구냥. …꼬리는 신경 쓰지 마라냥.", "집사 표정이 풀린 건 우연이다냥.", "이런 항목은 자리를 크게 잡는다냥.", "좋은 날이구냥. 이런 건 크게 적는다냥.", "기쁜 보고는 두 번 들어도 된다냥. 또 말해라냥.", "오늘은 도장을 좀 세게 찍겠다냥."],
      work_done: ["오늘 몫은 끝났다냥. 여기부턴 쉬는 구역이다냥.", "수고했다냥. …오늘은 많이 맞다냥.", "버틴 건 집사가 알아서 장부에 적는다냥.", "끝냈으면 됐다냥. 잘했는지는 안 따진다냥.", "일 끝난 사람은 여기서 쉬는 게 규정이다냥.", "오늘 분량 마감이다냥. 집사가 서류 덮었다냥.", "…수고했다냥. 두 번은 안 말하겠다냥."],
      commute: ["목표는 잘하는 게 아니라 돌아오는 거다냥.", "무사히만 다녀와라냥.", "자리는 그대로 둔다냥. 서두르지 마라냥.", "다녀와라냥. 접수대는 안 치운다냥.", "무리하지 마라냥. 이건 집사 업무 지시다냥.", "가는 길만 조심하면 된다냥. 나머지는 나중 일이라냥.", "돌아오면 여기서 보자냥."],
      washed: ["씻었냥? 훌륭한 생존 대업이다냥.", "집사가 제일 좋아하는 항목이다냥.", "그것만으로 오늘 몫은 했다냥. 도장 꺼내뒀다냥.", "씻는 건 자기 관리 대업 1급이라냥.", "그거 하나로 오늘은 통과다냥.", "뽀송해졌구냥. …보기 좋다냥.", "생활 문명 유지 항목이라냥. 제일 중요하다냥."],
      exercise: ["운동까지 했냥? …조금 놀랐다냥.", "오늘은 스스로 대단해해도 된다냥.", "운동 칸에 한 줄 채웠다냥.", "몸 움직였으면 그걸로 충분하다냥. 물 마셔라냥.", "…집사는 그런 거 못 한다냥. 대단한 거라냥.", "운동은 티가 안 나도 장부엔 남는다냥.", "무릎 조심해라냥. 이것도 규정이라냥."],
      quiet_day: ["별일 없는 하루도 접수한다냥 🐾", "특이사항 없음도 엄연한 보고다냥.", "사건 없는 서류가 제일 좋은 서류다냥.", "조용한 날 서류는 집사가 좋아한다냥.", "아무 일 없었으면 그게 제일 좋은 보고라냥.", "특별할 필요 없다냥. 그런 날도 다 접수된다냥.", "무사한 하루도 엄연한 성과라냥."]
    },
    ai: {
  ...
  const RELATIONSHIP_POOLS = {
    cat: {
      t2: {
        /* 방문 횟수·부재·대기를 세지 않는다 — 앱은 실제로 세지 않으므로
           대사가 세는 척만 해도 지어낸 감시가 된다. 편애는 집사가 혼자
           쓸데없는 짓을 한 장면으로만 드러낸다. */
        greeting: [
          "주인님 서류철을 괜히 한 번 더 정리했다냥. 이미 정리돼 있었다냥.",
          "오늘 제일 먼저 확인한 게 주인님 칸이다냥. 순서 문제다냥.",
          "주인님 서류철만 손때가 탔다냥. …원인 불명이다냥."
        ],
        miss: [
          "주인님 자리만 유난히 눈에 띈다냥. 이상하다냥.",
          "도장을 닦다가 비품팀한테 그만 닦으라는 말을 들었다냥.",
          "주인님 칸 서류를 각 맞춰 다시 꽂았다냥. …아까도 맞춰놨었다냥."
        ],
        love: [
      ...
      t3: {
        ...
        /* "기다리다 고생했다"는 부재를 죄책감으로 바꾼다. 사무국과의 마찰은
           집사가 혼자 벌인 쓸데없는 짓 때문이어야 한다. */
        miss: [
          "주인님 파일 라벨을 새로 써 붙였다냥. …멀쩡한 라벨이었다냥.",
          "비품 신청서에 주인님 서류철 새 덮개를 또 올렸다냥. 또 반려됐다냥.",
  ...
  const CAT_TONE_SHIFT = {
    ...
    // "해내라"는 완료 요구다 — 이 집사는 완료를 요구하지 않는다.
    withPlan: (mood, snippet) => `${toneShiftOpener(mood)}. 근데 ‘${snippet}’ 얘기 나오는 거 보니 벌써 좀 살아난 거 같다냥 ㅋㅋ 그건 그때 가서 하면 된다냥. 오늘 장부엔 안 올린다냥.`,
  ...
  const CAT_STORY_FALLBACK = {
    ...
    /* 인용할 구절조차 없을 때 나가는 마지막 그물. 제일 자주 열리는데 3줄이라
       금방 바닥났다. 여기서 사과하거나 되묻지 않는다 — 접수원은 모든 말에
       논평할 의무가 없고, 조용히 받는 것 자체가 답이다. */
    plain: [
      "그런 하루였구냥. 집사는 다 들었다냥. 더 있으면 마저 듣고 싶다냥.",
      "듣고 있다냥. 별거 아닌 것 같아도 접수는 해둔다냥.",
      "그렇구냥. 오늘 이야기는 여기 적어두겠다냥.",
      "접수했다냥. 설명 안 붙여도 된다냥.",
      "그런 날도 있다냥. 여기 적어두면 그걸로 끝이라냥.",
      "집사가 받아뒀다냥. 더 할 말 있으면 계속해도 된다냥.",
      "알겠다냥. 오늘 칸에 넣어두겠다냥.",
      "…듣고 있다냥. 급하게 정리 안 해도 된다냥."
    ]
  };
  /* ── 인용 반사 ──
  ...
  /* 뒤 세 줄은 「해석은 못 해도 기록은 정확하다」 쪽이다. 규칙으로 말을 읽는
     집사라 못 알아듣는 날은 반드시 오는데, 그때 사과하면 못 알아들었다는 게
     사건이 되고, 신입답게 정확히 받아 적으면 그건 그냥 이 집사의 일이 된다. */
  const CAT_QUOTE_REFLECT = snippet => [
    ...
    `‘${snippet}’… 한 글자도 안 고치고 적었다냥. 집사가 하는 일이 그거라냥.`,
    `‘${snippet}’… 무슨 뜻인지는 주인님이 제일 잘 알 거다냥. 집사는 적어두는 쪽이라냥.`,
    `‘${snippet}’… 이건 해석 안 붙이고 원문 그대로 두겠다냥.`
  ];
  ...
  function catExplicitEmotionLines(text, intent) {
    ...
    if (intent === "sad") {
      if (/슬프|슬퍼|서럽|눈물/.test(value)) return [
        ...
        "슬픈 마음이 그대로 있구냥. 급하게 괜찮아지려고 하지 않아도 된다냥.",
        "마음이 많이 무겁구냥. 지금은 말보다 곁이 필요하면 집사가 여기 있겠다냥."
      ];
      if (/우울|울적|공허|허무/.test(value)) return [
        "우울하구냥… 혼자 정리하려고 애쓰지 않아도 된다냥. 집사가 같이 있겠다냥.",
        "우울하구냥. 말하고 싶은 만큼만 들려줘도 된다냥. 조용히 있어도 괜찮다냥.",
        "마음이 가라앉아 있구냥. 오늘은 이유를 다 찾아내지 않아도 된다냥.",
        "우울한 마음을 혼자 들고 있었구냥. 집사한테 조금 내려놔도 된다냥."
      ];
  ...
  function catPhysicalDiscomfortLines(text) {
    ...
    if (/배|복부|속|메스꺼|토할|생리통/.test(value)) return [
      ...
      "배가 불편하구냥. 지금은 편한 자세로 쉬면서 몸부터 살펴라냥.",
      "배가 아프구냥. 집사가 성과 얘기는 안 하겠다냥. 더 심해지면 꼭 도움 받아라냥."
    ];
  ...
  function catEverydayCareLines(text) {
    const value = String(text || "");
    if (!CAT_EVERYDAY_CARE.test(value)) return null;
    if (/잠(?:이)?\s*안\s*(?:와|와요|오|온)|못\s*(?:자|잤)|불면/.test(value)) return [
      "잠이 안 오는구냥. 억지로 버티지 말고, 집사랑 잠깐 조용히 있자냥.",
      "아직 못 자고 있구냥. 말하고 싶은 게 있으면 조금 더 듣겠다냥."
    ];
    if (/무서(?:워|웠)|겁(?:이)?\s*나/.test(value)) return [
      "무섭구냥. 괜찮은 척 안 해도 된다냥. 집사가 여기 있겠다냥.",
      "겁이 났구냥. 지금 혼자 견디지 않아도 된다냥. 천천히 말해도 된다냥."
    ];
    if (/외로(?:워|웠|운)/.test(value)) return [
      "외롭구냥. 그 말 집사한테 해줘서 다행이다냥. 지금은 같이 있자냥.",
      "혼자인 것처럼 느껴졌구냥. 집사가 옆에서 조금 더 들어주겠다냥."
    ];
    return [
  ...
  function catConversationLines(text, result) {
    ...
    // 완료한 대업이 같이 있으면 그쪽이 먼저다 — "운동은 못 했는데 샤워는 했어"에
    // 못 한 쪽만 짚으면 한 일이 증발한다.
    if (result.negatedActivities?.length && !result.skippedCare?.length && !result.achievementCandidate) return [
