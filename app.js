(function () {
  ...
  const CHARACTER_PROFILES = {
    ...
    cat: {
      ...
      briefings: ["왔냥? 주인님 자리 비워뒀다냥.", "오늘 들어온 건 아직 없다냥. 하나면 된다냥.", "주인님 왔냥. 쉴 자리부터 정리해뒀다냥."],
      ...
      praise: [
        ["{deed}… 한 건이라도 있으면 된다냥. 금일 처리 업무 1건, 접수 완료다냥.", "{deed} 접수다냥. 사소해도 집사가 제대로 올려두겠다냥.", "{deed}… 별것 아니라고 해도 장부에는 넣는다냥. 그건 집사 고집이다냥.", "잘했네냥… 방금 딴 데 보면서 말한 건 맞다냥. 기록은 정성 들여 했다냥."],
  ...
  const CAT_FIRST_MEETING = [
    "{owner}이구냥. 첫 담당이라 준비를 좀 많이 했다냥… 전부 규정상이다냥.",
    "첫 발령이라 도장 방향도 세 번 확인했다냥… 긴장한 건 아니다냥.",
    "{owner} 자리부터 만들어뒀다냥… 첫 업무라 조금 일찍 준비했을 뿐이다냥."
  ];
  ...
  const CAT_HOME_LINES = [
    ["불렀냥? 접수대 바로 여기 있다냥.", "불렀냥? 별일 아니어도 된다냥.", "한 번 더 불러도 된다냥. 호출 기록이 늘어서 나쁘진 않다냥.", "집사 여기 있다냥. 계속 있었다냥."],
    // 「올 시간은 알고 있었다냥」이 여기 있었다. 집사가 접속 시간대를 안다는
    // 뜻이라 감시 경계를 넘는다 — 집사는 주인님이 적어준 것만 안다.
    ["또 눌렀냥. …싫다는 말은 안 했다냥.", "주인님 자리만 정리해뒀다냥.", "업무 중이었다냥. …지금은 아니다냥.", "결재판은 비워뒀다냥. 규정이다냥."],
    ["귀가 먼저 돌아갔다냥. 집사는 나중이다냥.", "주인님 서류만 손이 먼저 간다냥.", "왔네. 꼬리는 보지 말라냥.", "오늘 좀 보고 싶었다냥. 업무상이다냥."],
    ["필요한 건 미리 꺼내뒀다냥.", "부르자마자 여기 봤다냥. …우연히 준비돼 있었다냥.", "펜 떨어뜨렸다냥. 아무 일 없었다냥.", "주인님 자리 비워뒀다냥. 늘 그렇다냥."],
    ["주인님 서류부터 본다냥. 순서가 그렇다냥.", "결재는 바로 올린다냥. 접수함이 늘 열려 있다냥.", "오늘도 왔네. …나쁘지 않다냥.", "의자를 이쪽으로 돌려놨다냥. 아까부터다냥."],
