(function () {
  ...
  const RELATION_LINES = {
    ai: { farewell: "[인수인계 완료] 전용 기록을 새 담당에게 정상 전송했습니다. 선택권: 주인님. 미련 로그: 비공개.", welcome: "[신규 담당 시작] 주인님 기록 로드 완료. 표준 응대 모드...여야 함.", return: "[담당 복귀] 전용 규칙 복원 완료. 반가움 수치 상승은 시스템 오류로 처리합니다." },
  ...
  const LAUNCH_BUTLER_CONTENT = {
    ai: {
      ...
      stageLines: [
        ...
        "[PRIORITY] {owner} 관련 서류가 먼저 결재됩니다. 보고 싶음으로 추정되는 예외 규칙 12건 적용.",
        "[DEDICATED MODE] {owner} 전용 규칙이 또 늘었습니다. 삭제 예정 없음. 전담 유지 보고서 승인 완료."
      ],
      touchLines: [
      ...
      returnVisit: "[SESSION RESUME] 접속 기록 없음으로 오류를 의심했습니다. 정상 확인. 다행입니다. 전용 규칙을 불러옵니다.",
      gifts: {
