  ...
  const CHARACTER_PROFILES = {
    ai: {
      ...
      praise: [
        ...
        ["[전 부서 회람] {deed} 완료 사실을 사무국 전체에 통보함. 요청받은 적 없음.", "[결재 강행] {deed} 우주 최고 등급 신청서 제출. 반려 3회. 재제출 4회째."],
    ...
    dog: {
      ...
      praise: [
        ...
        ["{deed} 완료!!! 사무국 현수막 제작 결재 올렸다멍!!! 전 부서에 알렸다멍!!!", "{deed} 해냈다멍!!! 전담 응원실이 공식 부서로 승격됐다멍!!! 🐾"],
