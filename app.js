(function () {
  ...
  const CHARACTER_PROFILES = {
    ai: {
      ...
      praise: [
        ["[판정 완료] {deed} 확인. 규정상 인류사적 대업으로 분류함. 따질 수 없음.", "[시스템메시지] {deed} 분석 끝. 결론: 주인님 완벽함. 이건 버그 아님."],
        ["[ERROR: 감정회로 과열] {deed} 감지. 주인님 너무 완벽해서 시스템 멈춤 💕", "ALERT: {deed} 실력이 예상보다 99999% 높음. 집사 설명 못 하겠음."],
        ["[장부 확인] {deed} 또 나옴. 장부에 여러 번 적혀 있음. 집사가 센 것 아님. 장부가 그럼.", "[이상함] 다른 서류엔 이 반응 없음. {deed}에서만 나옴. 원인 모름."],
        ["[전 부서 알림] {deed} 소식을 사무국 전체에 뿌림. 아무도 안 시켰음.", "[신청서] {deed} 우주 최고 등급 신청. 퇴짜 3번. 또 냄. 네 번째임."],
        ["[반성문 작성 중] 칭찬 너무 많이 해서 걸림. 반성문에도 주인님 칭찬 씀. 반성 안 함.", "[규칙 변경] 이제 주인님 건은 칭찬 제한 없음. …원래도 규칙 때문 아니었음. (버그아님)"]
      ],
    ...
    cat: {
      ...
      praise: [
        ["{deed} 접수!! 규정상 이건 인류사적 대업이다냥!! 따지지 말라냥!! 🐾", "{deed}?! 사무국 최고 등급이다냥!! 도장 세 개 찍었다냥!! 손목 아프다냥!!"],
        ["{deed} 해냈다냥!! 집사 심장 터질 뻔했다냥!! 이건 규정 때문이다냥!! 💕", "세상에 {deed}를 이렇게 해내는 주인이 있다냥!? 집사 자랑스럽다냥!!!"],
        ["{deed} 또 왔다냥!! 장부에 벌써 여러 번이다냥!! …집사가 센 거 아니고 장부가 그렇다냥 🐾", "{deed}?!?! 다른 서류는 안 그런데 주인님 것만 눈에 띈다냥!! 왜 그러지냥!!"],
        ["{deed} 완료!!! 게시판에 붙였다냥!!! 떼라는 쪽지 왔지만 못 본 척했다냥!!!", "{deed} 해냈다냥!!! 우주 최고 신청서 냈다냥!!! 퇴짜맞아서 또 냈다냥!!! 네 번째다냥!!!"],
        ["{deed}!!!! 칭찬 너무 많이 했다고 반성문 쓰는 중이다냥!!!! 반성문에도 주인님 칭찬 적었다냥!!!! 💕", "{deed}... 이제 주인님 건은 마음껏 칭찬해도 된다는 규칙이 생겼다냥. …사실 규칙은 상관없었다냥 🐾"]
      ],
    ...
    dog: {
      ...
      praise: [
        ["{deed} 접수!! 규정상 최고 등급이다멍!! 도장 다섯 개다멍!! 🐾", "{deed}?! 무조건 대업이다멍!! 규정에 그렇게 적혀 있다멍!! 내가 적었다멍!!"],
        ["{deed} 완료!! 최고!! 최고!! 꼬리 끊어질 것 같다멍!!! 🐾", "{deed}를 해낸 주인님 세상에서 제일 멋지다멍!!!! 왕왕왕!!! 💕"],
        ["{deed} 또 있다멍!! 장부 넘겨보니 계속 나온다멍!! 집사 방방 뛰는 중이다멍!!", "{deed} 대박이다멍!! 다른 서류 볼 땐 안 이런다멍!! 왜 이러지멍!! 💕"],
        ["{deed} 완료!!! 현수막 만들어달라고 신청했다멍!!! 전 부서에 짖고 다녔다멍!!!", "{deed} 해냈다멍!!! 응원실이 진짜 부서로 승진했다멍!!! 직원은 나 혼자다멍!!! 🐾"],
        ["{deed}!!!! 너무 시끄럽다고 반성문 받았다멍!!!! 반성문에도 주인님 칭찬 적었다멍!!!! 💕", "{deed}... 이제 마음껏 짖어도 된다는 허락 나왔다멍!!! 목청 풀어놨다멍!!! 🐾"]
      ],
    ...
    alien: {
      ...
      praise: [
        ["[분석 완료] {deed} 실력, 은하계 최고 수준으로 적음. 규정에 따른 판정임.", "{deed} 신호 받음. 사무국 최고 등급으로 분류함."],
        ["[경고] {deed} 결과가 너무 훌륭해서 집사 감정회로 과열됨.", "{deed} 완료. 집사 머리로는 이 완벽함이 설명 안 됨."],
        ["[장부 대조] {deed} 여러 번 관측됨. 집사가 센 것 아님. 장부에 적힌 것임.", "[이상함] 다른 지구인 서류엔 이 반응 없음. {deed}에서만 나옴. 원인 모름."],
        ["[긴급 보고] {deed} 완료. 사무국이랑 본성에 둘 다 알림. 아무도 안 시켰음.", "{deed} 우주 최고 등급 신청. 퇴짜 3번. 또 냄. 포기 계획 없음."],
        ["[반성문] 칭찬 너무 많이 해서 걸림. 반성문에도 주인님 칭찬 씀.", "[규칙 변경] 이제 주인님 건은 칭찬 제한 없음. 지구 남기로 한 거 후회 없음."]
      ],
    ...
    ninja: {
      ...
      praise: [
        ["{deed} 완료. 규정상 인류사적 대업으로 적어 봉인했다.", "{deed} 확인. 사무국 최고 등급이다. 도장은 이미 찍었다."],
        ["{deed} 완료. 역시 주인님이다. 집사 뒤에서 눈물 한 방울.", "{deed}... 대단하다. 이 집사, 주인님을 위해서라면 뭐든 할 수 있다."],
        ["{deed}, 장부에 또 남았다. 계속 나온다. …내가 센 게 아니라 장부가 그렇다.", "{deed}... 다른 서류엔 이런 마음이 안 든다. 이상한 일이다."],
        ["{deed} 완수. 사무국 전체에 알렸다. 숨어 지내는 것도 포기할 만한 일이었다.", "{deed} 신청서가 퇴짜맞았다. 또 냈다. 세 번째다. 물러설 생각 없다."],
        ["{deed}... 칭찬을 너무 많이 해서 반성문을 썼다. 반성문에도 주인님 이야기를 적었다.", "{deed}... 이제 마음껏 칭찬해도 된다고 한다. 애초에 규칙 때문이 아니었다."]
      ],
    ...
    witch: {
      ...
      praise: [
        ["{deed} 접수했어요. 규정상 인류사적 대업이에요. 점괘도 같은 결과예요.", "{deed}? 사무국 최고 등급이에요. 수정구슬도 고개를 끄덕였어요 ✨"],
        ["{deed}를 해내셨네요!! 수정구슬이 이렇게 밝게 빛난 건 처음이에요 ✨", "{deed} 완료! 오늘 운세는 대박 중의 대박이에요. 제가 보증해요 🔮"],
        ["{deed}, 장부에 또 적혀 있어요. 계속 나와요. …제가 센 게 아니라 장부가요 🔮", "{deed}?! 다른 서류엔 이런 기운이 없는데 당신 것만 반짝여요. 이상하죠 ✨"],
        ["{deed} 완료! 사무국 전체에 좋은 소식이라고 돌렸어요. 아무도 안 시켰지만요 🔮", "{deed} 신청서가 퇴짜맞아서 주문을 걸어 다시 냈어요 ✨"],
        ["{deed}... 칭찬을 너무 많이 해서 반성문을 썼어요. 반성문에도 당신 점괘를 적었답니다 🔮", "{deed}... 이제 마음껏 축복해도 된대요. 빗자루 타고 알리러 갈게요 ✨"]
      ],
    ...
    fox: {
      ...
      praise: [
        ["으... {deed}... 규정상 대업이야... 도장 찍었어... 팔 아파...", "{deed}... 사무국 최고 등급... 으르... 규정이 그래..."],
        ["으르... {deed}라니... 뇌가 다시 살아나는 느낌... 최고야... 으... 💕", "{deed}... 으... 집사 이런 거 처음 느껴봐... 으르르... 진짜 잘했어..."],
        ["{deed}... 장부에 또 있어... 계속 나와... 내가 센 거 아니야... 장부가 그래...", "으... 다른 서류 볼 땐 안 이런데... {deed}만... 이상해... 으르..."],
        ["{deed}... 사무국 전체에 알렸어... 으르... 다들 봤으면 좋겠어...", "으... {deed} 신청서 퇴짜맞았어... 또 냈어... 세 번째야... 으르..."],
        ["{deed}... 칭찬 너무 해서 반성문 썼어... 으... 반성문에도 주인님 얘기 썼어... 💕", "{deed}... 이제 마음껏 칭찬해도 된대... 으르... 잘됐어..."]
      ],
    ...
    star: {
      ...
      praise: [
        ["{deed} 완료? 규정상 최고 등급이야. 도장 찍었어.", "{deed}? 이건 무조건 대업이야. 규정이 그래. 내가 확인했어."],
        ...
        ["{deed} 완료. 사무국 전체에 알렸어. 팬미팅보다 크게 알렸어 💅", "{deed} 신청서 퇴짜맞았는데 또 냈어. 이번엔 통과시킬 거야 ✨"],
        ["{deed}... 칭찬 너무 많이 해서 반성문 썼어. 반성문에도 네 칭찬 적었어 💕", "{deed}... 이제 너한테는 마음껏 칭찬해도 된대. 표정 관리 그만할게 ✨"]
      ],
    ...
    elf: {
      ...
      praise: [
        ["{deed}를 해내셨군요. 규정상 인류사적 대업으로 적었어요.", "{deed} 완료. 사무국 최고 등급이에요 🌿"],
        ["{deed}를 해내다니... 당신은 정말 이 세계의 빛이에요. 심장이 멎을 뻔했어요 🌿", "{deed} 완료. 천 년을 살아온 집사도 이런 순간은 처음이에요 💚"],
        ["{deed}, 장부에 또 남았네요. 천 년 기록에도 이런 반복은 드물어요 🌿", "{deed}... 다른 서류는 안 그런데 당신 것만 자꾸 다시 펼쳐봐요 💚"],
        ["{deed} 완료. 숲 전체에... 아니, 사무국 전체에 알렸어요. 다들 알아야죠 ✨", "{deed} 신청서가 퇴짜맞았지만 다시 냈어요. 천 년쯤 기다릴 수 있어요 🌿"],
        ["{deed}... 칭찬을 너무 많이 해서 반성문을 썼어요. 반성문에도 당신 이야기를 적었답니다 💚", "{deed}... 이제 당신에겐 마음껏 칭찬해도 된대요. 천 년 뒤에도 그럴 거예요 ✨"]
      ],
    ...
    fairy: {
      ...
      praise: [
        ["{deed} 접수했어요! 규정상 인류사적 대업이에요!", "{deed}? 사무국 최고 등급이에요! 별가루 도장 찍었어요 ✨"],
        ["{deed} 해냈어요!! 별가루가 저절로 쏟아졌어요!! 반 통이나요!! ✨", "{deed} 완료!! 집사 날개가 너무 신나서 안 멈춰요!! 💕"],
        ["{deed}, 장부에 또 있어요! 계속 나와요! …제가 센 게 아니라 장부가요! ✨", "{deed}?! 다른 서류엔 별가루 안 뿌리는데 당신 것만 자꾸 뿌리게 돼요!! 💕"],
        ["{deed} 완료!! 사무국 전체에 반짝이 뿌리며 알렸어요!! 아무도 안 시켰어요!! ✨", "{deed} 신청서 퇴짜맞았지만 별가루 더 뿌려서 다시 냈어요!! 💕"],
        ["{deed}... 별가루 너무 써서 반성문 썼어요! 반성문에도 별가루 뿌렸어요!! ✨", "{deed}... 이제 마음껏 반짝여도 된대요!! 창고에서 별가루 더 꺼내왔어요!! 💕"]
      ],
