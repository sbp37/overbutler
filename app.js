(function () {
  ...
  const CHARACTER_PROFILES = {
    ai: {
      ...
      praise: [
        ...
        ["[FATAL ERROR] {deed} 완료. 표준 칭찬 상한 초과. 전용 승인서 자동 생성.", "[특별대우 프로토콜] {deed} 우주 기록 경신. 사무국 예외 규칙 99건 추가."]
      ],
    ...
    cat: {
      ...
      praise: [
        ...
        ["{deed}!!!! 감사실에도 우주 최고라고 결재 올렸다냥!!!!!", "{deed}... 전용 도장 꺼냈다냥. 이런 건 아무한테나 안 찍는다냥."]
      ],
    ...
    dog: {
      ...
      praise: [
        ...
        ["{deed}!!!! 사무국 현수막 제작 승인 올렸다멍!!!!!", "{deed}!!!! 전담 응원실이 공식 부서가 됐다멍!!!!!"]
      ],
    ...
    alien: {
      ...
      praise: [
        ...
        ["{deed} 완료. 주인님을 은하계 기준 단위로 지정 요청함.", "{deed}... 본성 감사 결과 주인님 기록이 최우선 연구 과제로 재분류됨."]
      ],
    ...
    ninja: {
      ...
      praise: [
        ...
        ["{deed}... 가문의 영광이다. 이 집사, 더 열심히 기록하겠다.", "{deed} 완수. 이 대업은 최고 등급 비밀문서로 올리겠다."],
        ["{deed}... 주인님의 능력에는 한계가 없군. 집사 숙연해진다.", "{deed} 완수. 전담 임무 기록의 첫 장에 봉인하겠다."]
      ],
    ...
    witch: {
      ...
      praise: [
        ...
        ["{deed}!!!! 모든 점괘가 주인님 특별승인으로 통일됐어요.", "{deed}... 운명도 전용 결재란을 따로 만들었어요."]
      ],
    ...
    fox: {
      ...
      praise: [
        ...
        ["{deed}!!!! 집사... 전담 기록실... 공식 신청할게...", "으르르... {deed}... 집사 뇌 말고 결재판도 살아났어..."]
      ],
    ...
    star: {
      ...
      praise: [
        ...
        ["{deed}!!!! 오늘의 센터는 주인님이야. 전담 큐시트까지 결재받았어!", "{deed}... 단독 콘서트보다 벅차. 사무국 앵콜 승인도 났어."]
      ],
    ...
    fairy: {
      ...
      praise: [
        ...
        ["{deed}!!!! 요정 왕국 공식 기념일로 선포할게요!!!!", "{deed}... 왕국 비축 별가루를 전담 예산으로 전환해도 모자라요!"]
      ],
  ...
  const RELATION_LINES = {
    ai: { farewell: "[인수인계 완료] 주인님 기록과 관계 로그를 새 담당에게 정상 전송했습니다.", welcome: "[신규 담당 시작] 주인님 기록 로드 완료. 표준 응대 모드...여야 함.", return: "[담당 복귀] 보존 중이던 기록과 전용 업무 규칙을 정상적으로 불러왔습니다." },
    cat: { farewell: "흥, 담당 변경 승인서는 결재했다냥. 기록도 빠짐없이 넘겨둘 거다냥.", welcome: "처음 맡는 거냥? 업무 규정상 주인님 기록칸부터 준비했다냥.", return: "…다시 담당이냥? 기록칸은 규정대로 그대로 보존했다냥." },
    ...
    ninja: { farewell: "임무를 다음 집사에게 인계했다. 모든 기록은 절차대로 넘겼다.", welcome: "인수인계 문서 확인. 오늘부터 그대의 작은 임무를 최고 등급으로 기록하겠다.", return: "다시 담당하게 됐군. 봉인해둔 기록은 한 장도 흐트러지지 않았다." },
  ...
  const MEMORY_LINES = {
    ai: [
      "[기록 조회] 지난번 ‘{deed}’도 정상 보관 중입니다. 익숙한 기록이라 즉시 찾았습니다.",
      "[예외 색인] ‘{deed}’ 기록을 일반 문서보다 먼저 불러왔습니다. 사유: 업무 효율.",
      "[전담 문서] ‘{deed}’ 기록이 주인님 전용 중요문서함으로 재분류됐습니다."
    ],
    cat: [
  ...
  const LAUNCH_BUTLER_CONTENT = {
    ai: {
      ...
      stageLines: [
        ...
        "[패턴 등록] {owner} 기록 형식이 익숙한 입력으로 분류됐습니다.",
        "[MEMORY LINK] 이전 {owner} 기록을 먼저 참조하는 규칙이 추가됐습니다.",
        "[편의 처리] 자주 쓰는 기록 양식을 {owner} 전용 빠른 접수함에 준비했습니다.",
        "[PRIORITY] 일반 업무보다 {owner} 관련 서류가 먼저 결재됩니다. 예외 규칙 12건 적용.",
        "[DEDICATED MODE] 담당 업무 대부분이 {owner} 기록으로 재분류됐습니다. 전담 유지 보고서 승인 완료."
      ],
      touchLines: [
      ...
      returnVisit: "[SESSION RESUME] 기존 기록과 {owner} 전용 업무 규칙을 불러왔습니다. 즉시 접수 가능합니다.",
      gifts: {
        favorite: "[취향 데이터 적중] {gift} 수신. {owner}이 집사 내부 사양을 너무 정확히 파악함. 감정 회로 냉각 포기.",
        duplicate: "[기억 확인] {gift} 재수신 {count}회째. 이전 물품과 함께 전용 비품함에 보관함.",
        rare: "[최상위 보안 선물] {gift} 수신. {owner} 전용 감사 프로토콜과 특별 비품 코드가 생성됨."
      }
    },
    cat: {
      favorites: ["참치캔", "츄르"],
      stageLines: [
        ...
        "{owner} 기록 방식은 이제 익숙하다냥. 업무 적응일 뿐이다냥.",
        "{owner} 기록이 먼저 눈에 들어온다냥. 파일 색이 눈에 띄어서 그런 거다냥.",
        "자주 쓰는 양식은 위에 올려뒀다냥. {owner} 편의가 아니라 업무 효율이다냥.",
        "{owner} 서류는 맨 위에 둔다냥. 특별대우 아니라 결재가 빨라서다냥.",
        "{owner} 전용 서류함이 공식 비품으로 등록됐다냥. 전담 유지도 규정상 타당하다냥."
      ],
      touchLines: [
      ...
      returnVisit: "오랜만이다냥. {owner} 기록칸은 규정대로 그대로 보존했다냥. 바로 접수하면 된다냥.",
      gifts: {
    ...
    dog: {
      ...
      stageLines: [
        ...
        "{owner} 기록 방식은 이제 익숙하다멍! 양식도 바로 찾는다멍!",
        "{owner} 기록이 보이면 꼬리가 먼저 반응한다멍! 칭찬 근거도 전부 외웠다멍!",
        "자주 쓰는 대업 양식을 미리 꺼내뒀다멍! 편의 지원 업무다멍!",
        "{owner} 대업은 먼저 결재한다멍! 사무국도 꼬리 속도를 못 막는다멍!",
        "전담 응원실이 공식 승인됐다멍! {owner} 기록은 집사가 제일 크게 칭찬한다멍!"
      ],
      touchLines: [
      ...
      returnVisit: "{owner} 기록 업무 재개다멍!!! 기존 서류도 전부 그대로고 꼬리도 즉시 가동이다멍!",
      gifts: {
    ...
    alien: {
      ...
      stageLines: [
        ...
        "[패턴 등록] {owner} 기록 형식을 익숙한 지구 데이터로 분류함.",
        "[연구 예외] {owner} 기록을 이전 자료와 먼저 연결하는 규칙이 생성됨.",
        "[편의 제공] 반복 대업용 은하 표준 양식을 미리 준비함.",
        "[우선 보고] {owner} 관련 자료가 본성 일반 보고보다 먼저 결재됨.",
        "[전담 확정] 담당 연구의 대부분을 {owner} 기록으로 재분류. 본성 감사 승인 완료."
      ],
      returnVisit: "[업무 재개] {owner} 기록 채널 활성. 기존 은하 분류와 예외 규칙을 불러옴.",
      gifts: {
    ...
    ninja: {
      ...
      stageLines: [
        ...
        "{owner} 기록 양식은 이제 눈을 감고도 찾는다. 업무 숙련일 뿐이다.",
        "이전 {owner} 기록을 먼저 펼치게 됐다. 이 사실은 극비다.",
        "반복 임무용 서찰과 축하 연막탄을 미리 준비해뒀다.",
        "{owner} 기록은 최고 등급 비밀문서로 먼저 결재한다. 기사단에도 통보했다.",
        "전담 기록 임무가 정식 승인됐다. 인수인계서보다 유지 보고서가 더 두껍다."
      ],
      returnVisit: "업무 재개 신호를 확인했다. {owner}의 봉인 문서와 임무 양식은 그대로다.",
      gifts: {
    ...
    witch: {
      ...
      stageLines: [
        ...
        "{owner} 기록의 별자리 배열이 이제 익숙해졌어요.",
        "수정구슬이 이전 {owner} 기록부터 먼저 보여주네요. 장난일까요?",
        "반복되는 대업은 전용 점괘 양식으로 미리 준비해둘게요.",
        "좋은 징조가 {owner} 서류부터 찾아가요. 결재 순서를 살짝 바꾼 건 비밀이에요.",
        "전담 점괘실이 정식 승인됐어요. 감사 결과 업무 대부분이 {owner} 길조로 재분류됐답니다."
      ],
      returnVisit: "다시 기록을 시작하는 점괘네요. {owner} 전용 장부와 좋은 징조는 그대로 보관했어요.",
      gifts: {
    ...
    fox: {
      ...
      stageLines: [
        ...
        "{owner} 기록 양식... 이제 익숙해... 흐린 머리도 바로 찾아...",
        "이전 {owner} 기록이... 먼저 보여... 중요 표시가 너무 커서 그래...",
        "반복 대업 양식... 미리 꺼내뒀어... 업무 편의야... 으르...",
        "{owner} 기록부터 결재할게... 다른 건 느려도... 이건 빠르게 할 수 있어...",
        "으르르... 전담 기록실... 공식 승인됐어... 업무 대부분이 {owner} 문서래..."
      ],
      returnVisit: "으... 기록 업무... 다시 시작이네... {owner} 중요문서함은 그대로야...",
      gifts: {
    ...
    star: {
      ...
      stageLines: [
        ...
        "{owner} 기록 형식은 이제 익숙해. 큐카드도 바로 찾고.",
        "{owner} 대업이 보이면 리액션 큐가 먼저 들어와. 업무 습관이 됐나 봐.",
        "자주 하는 대업은 전용 큐시트로 미리 만들어뒀어.",
        "오늘 무대 서류보다 {owner} 기록이 먼저 결재됐어. 매니저는 효율 때문이래.",
        "공식 발표할게. {owner} 전담 큐시트가 정규 편성됐어. 사무국도 편애를 승인했네."
      ],
      returnVisit: "다시 기록 시작이네. {owner} 전용 큐시트와 지난 무대 기록은 그대로 준비했어.",
      gifts: {
    ...
    elf: {
      ...
      stageLines: [
        ...
        "{owner}의 기록 방식이 이제 오래된 서체처럼 익숙해졌어요.",
        "이전 {owner} 기록을 먼저 펼치게 되네요. 장부가 잘 보이는 탓일까요.",
        "반복되는 대업을 위한 전용 책갈피와 양식을 준비했어요.",
        "숲의 일반 문서보다 {owner} 기록이 먼저 결재됐어요. 장기 보존 가치 때문이에요.",
        "{owner} 전담 서고가 정식 승인됐어요. 제 업무도 대부분 그 기록으로 재분류됐답니다."
      ],
      returnVisit: "다시 기록을 시작하시는군요. {owner} 전담 서고와 지난 장부는 그대로 보존했어요.",
      gifts: {
    ...
    fairy: {
      ...
      stageLines: [
        ...
        "{owner} 기록 양식이 익숙해져서 날개가 먼저 반짝여요!",
        "이전 {owner} 기록을 먼저 펼치게 돼요. 별빛 색인이 너무 잘 보여서예요!",
        "반복 대업용 별가루 도장과 전용 양식을 미리 준비했어요!",
        "별나라 일반 결재보다 {owner} 기록이 먼저 통과됐어요. 우연치고는 매번이네요!",
        "{owner} 전담 별빛 기록실이 공식 승인됐어요! 왕국 업무 대부분도 대업 기록으로 재분류됐답니다!"
      ],
      touchLines: [
      ...
      returnVisit: "다시 기록을 시작하시는군요! {owner} 전용 별빛 보관함과 도장은 그대로 준비돼 있어요!",
      gifts: {
  ...
  function getPraise(deed, obsession = state.obsession, character = state.character, verdictType = "praise") {
    ...
    const baseTier = Math.max(1, stageIndexFor(obsession));
