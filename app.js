(function () {
  ...
  const DESK_PLATES = Object.freeze({
    ...
    cat: { text: "첫기록과 · 주인님", recall: "「첫기록과 · 주인님」으로 적었다냥. 집사가 처음 맡은 파일이니까다냥." }
  });
  ...
  const LAUNCH_BUTLER_CONTENT = {
    ...
    cat: {
      ...
      stageLines: [
        ...
        "첫기록과에서 집사 서류가 반듯하다고 칭찬했다냥. 주인님 이야기를 잘 맡은 덕이다냥.",
      ...
      stageLinesNoRecord: [
        ...
        "첫기록과에서 접수대 준비가 반듯하다고 칭찬했다냥. 첫 주인님 자리를 잘 준비한 덕이다냥.",
      ...
      returnVisit: [
        ...
        "왔냥? 첫기록과에서 칭찬받은 집사가 직접 마중 나왔다냥. 들뜬 건 아니다냥… 주인님 덕이다냥.",
